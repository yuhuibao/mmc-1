...
__device__ void copystate(GRandType *t, GRandType *tnew){
    tnew[0]=t[0];
    tnew[1]=t[1];
}
 ...
 */
__device__ void gpu_rng_reseed(GRandType t[RAND_BUF_LEN],uint cpuseed[],uint idx,float reseed){
}
